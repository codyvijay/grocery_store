        ...
        <div class="card-group">
            ...
            <div class='col-6'>
                ...
                <h4 class="py-4">Required Info</h4>
                    ...
                    <div class='fs-gap p-2'>
                        <h4>Store ID</h4>
                        <input type='text' name='store_id' class='form-control'  style='width:200%; max-width:400px;' v-model='credential.user_id' disabled/>
                    </div>
                </div>
            </div>
            <div class="col-6">
                ...
                <h4 class="py-4">Personal Info</h4>
                    <div class='fs-gap p-2'>
                        <h4>Store Name</h4>
                        <input type='text' name='store_name' class='form-control'  style='width:200%; max-width:400px;' v-model='credential.store_name'/>
                    </div>
                    <div class='p-2'>
                        <h4>First Name</h4>
